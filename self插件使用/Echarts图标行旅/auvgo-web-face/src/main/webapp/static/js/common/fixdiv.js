...
(function() {
    ...
    anjiehotel.module.address = function(k) {
        ...
        function S() {
            var a = [],b;
            for (b in f.hotData) { //迭代address.js里面$$.module.address.source.hotel_hotData里面的属性，b为"热门"、"abc"这些属性            
                var c = [],
                /*下方正则表达式提取的是每个城市的数据，即a为匹配项即每个城市的信息，格式：@bji|北京|BJP|0*/
