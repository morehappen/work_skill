...
$('body').on("click",".add_size",function () {
	...
	var list = '<div class="clear passanger-container passanger_model_msg" style="position: relative;">' +
		...
		'<div class="float-left p-w-200 papers pdd-mar">证件类型</div>' +
		...
		'<div class="p-w-200 papers pdd-mar">证件号码</div>' +
		...
		'</div>' +
		'<div class="float-left clear margn-bottom-5">' +
		'<div class=" p-w-200 papers pdd-mar">证件姓名</div>' +
		...
		'<div class=" p-w-200 papers pdd-mar">性别</div>' +
