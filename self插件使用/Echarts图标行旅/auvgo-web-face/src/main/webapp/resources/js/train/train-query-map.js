...
// 点击显示自定义窗口
    ...
    function hotelOrig(hotelOrign,aPrice){
        ...
        var htmlstr =  '<div class="bmap-wraper">' +
            ...
            '<span class="color-purple font-size-18 font-600">' + aPrice+ '</span>' +
            '<span class="color-999">起</span>' +
            '</div>' +
            '<div class="float-right">' +
            '<button type="button" class="btn btn-default btn-big go-detail" onclick="bmapClick(this);" data-id="' + hotelOrign.hotelNo + '" data-name="' + hotelOrign.addressCn + '" >查看</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
