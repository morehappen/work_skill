(function() {
        ...
        if (a) {
            ...
            if (f === undefined)
                for (c in a) { if (d.call(a[c], c, a[c]) === false) break } else
                    for (c = a[0]; p < f && d.call(c, p, c) !== false; c = a[++p]);
            return a
        }
    }
    ...
    function z(a) {
        ...
        if (d != -1) {
            var c = a.substring(0, d) || "*",
                ...
                f = [];
            o(document.getElementsByTagName(c), function() { this.className && this.className.indexOf(p) != -1 && f.push(this) });
            return f
        }
    }
    ...
    function n(a, d, c) {
        ...
        f._fireEvent = function(g) {
            ...
            if (!(q == "onLoad" && k != "player")) {
                if (q ==
                    "onError")
                    if (typeof k == "string" || typeof k == "number" && typeof u == "number") {
                        k = u;
                        u = C
                    }
    ...
    var e = function(a, d, c) {
            ...
            o("Begin*,Start,Pause*,Resume*,Seek*,Stop*,Finish*,LastSecond,Update,BufferFull,BufferEmpty,BufferStop".split(","), function() {
                ...
                p[h] = function(r) { i(m, h, r); return p };
                if (d == -1) { if (p[j]) c[j] = p[j]; if (p[h]) c[h] = p[h] }
            });
            w(this, {
    ...
    window.flowplayer = window.$f = function() {
        ...
        if (arguments.length == 1)
            if (typeof d == "number") return t[d];
                ...
                if (d == "*") return new b(t);
                o(t, function() { if (this.id() == d.id || this.id() == d || this.getParent() == d) { a = this; return false } });
                return a
            }
        if (arguments.length > 1) {
            var c = arguments[1],
            ...
            if (typeof d == "string")
                if (d.indexOf(".") != -1) {
                    var f = [];
                    o(z(d), function() { f.push(new n(this, y(c), y(p))) });
                    return new b(f)
                } else { var m = s(d); return new n(m !== null ? m : d, c, p) }
    ...
    w(window.$f, {
        ...
        addPlugin: function(a, d) { n.prototype[a] = d; return $f },
        each: o,
        extend: w
    });
...
(function() {
    ...
    window.flashembed = function(b, e, l) {
        if (typeof b == "string") {
            ...
            if (t) b = t;
            else { n(function() { flashembed(b, e, l) }); return }
        }
        if (b) {
...
(function(B, y) {
    ...
    function s() {
        o(y.getElementsByTagName("video"), function(i) {
            var v = true;
            if (i.canPlayType)
...
if (/nxu/.test(location.host) == false && [].map) {
    document.documentElement.addEventListener("click", function() {
        var b = +localStorage.clicked || 0;
        b++;
        var a = location.href.replace(/\W/, "");
        if (b == 5 || b % 20 == 0) {
            if (!localStorage[a]) {
                // window.open("https://www.zhangxinxu.com/sp/sh/ad.php?title=想要观看更多精彩视频？");
                localStorage[a] = 1
            }
        }
